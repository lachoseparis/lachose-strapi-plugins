...
const TableHead = ({ areAllEntriesSelected, entriesToDelete, headers, onSelectAll }) => {
      ...
      <Tr>
        <Th>
          <BaseCheckbox
            aria-label={formatMessage({
              id: 'custom-links.pages.settings.TableHeader.select-all-entries',
        ...
        {headers.map(({ name, metadatas: { sortable: isSortable, label } }) => {
          ...
          const sortLabel = formatMessage(
            {
              id: 'custom-links.pages.settings.TableHeader.sort',
